...
/*cette fonction a ete genere par ChatGPT*/
/*a l'aide du prompt : "Peux-tu me generer un code C sur Nios2 qui récupère une une valeur de distance et qui l'affiche sur les 4 premiers afficheurs 7 segments ?"*/
